...
function PageExtractEditor({
  ...
  if (!(file instanceof File)) {
    return <p className="qc-muted">Add one PDF to select pages to extract.</p>
  }
  ...
  return (
    <div className="qc-page-extract">
      <div className="qc-page-delete__summary">
        <p>
          Select pages to extract. {selectedPages.length} of {pdfDocument.numPages} selected.
        </p>
        ...
        {pageNumbers.map((pageNumber) => {
          ...
          return (
            <li key={pageNumber}>
              <button
                type="button"
                className={`qc-page-extract__item ${selected ? 'is-selected' : ''}`}
              ...
              >
                ...
                <span>{selected ? 'Selected for extraction' : 'Not selected'}</span>
              </button>
            </li>
          )
        })}
...
export default PageExtractEditor
